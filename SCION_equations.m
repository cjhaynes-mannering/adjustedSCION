...
%amp0
%amplification_factor = interp1qr([-600 -460 -458 -455 -447 -445 -442 -380 -377 -375 -370 -367 0]',[1 1 2 1 1 2 1 1 3 1 3 1 1]',t_geol) ;

%amp1
amplification_factor = interp1qr([-600 -460 -458 -455 -447 -445 -442 -380 -378 -376 -374 -370 0]',[1 1 2 1 1 2 1 1 1.8 2.5 3 1 1]',t_geol) ;

%amp2
%amplification_factor = interp1qr([-600 -460 -458 -456 -447 -445 -443 -420 -417 -415 -390 -388 -386 0]',[1 1 2 1 1 3 1 1 3 1 1 4 1 1]',t_geol) ;

%amp3
%amplification_factor = interp1qr([-600 -460 -458 -456 -447 -445 -443 -420 -417 -415 -380 -378 -376 -374 -372 -370 -365 -360 0]',[1 1 2 1 1 3 1 1 3 1 1 4 1 1 1.8 2.5 3 1 1]',t_geol) ;

%amp4
%amplification_factor = interp1qr([-600 -460 -458 -456 -447 -445 -443 -420 -417 -415 -380 -378 -376 -374 -372 -370 -365 -360 0]',[1 1 2 1 1 3 1 1 3 1 1 3 1 1 3 4 3 1 1]',t_geol) ;

%amp5 - balanced O2 and c-perturbation-balance
%amplification_factor = interp1qr([-600 -460 -458 -456 -447 -445 -443 -420 -417 -415 -380 -378 -376 -374 -372 -370 -365 -360 0]',[1 1 2 1 1 3 1 1 3 1 1 2 1 1 2 2.5 2 1 1]',t_geol) ;

%amp6 - best?
%amplification_factor = interp1qr([-600 -460 -458 -456 -447 -445 -443 -420 -417 -415 -400 -380 -378 -376 -374 -372 -370 -367 -364 -360 -358 0]',[1 1 2 1 1 3 1 1 2 1 2 1 3 2 3 2 3 1 3 2 1 1]',t_geol) ;
